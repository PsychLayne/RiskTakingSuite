...
from ui.experiment_creator import ExperimentCreator
...
class RiskTasksClient(ctk.CTk):
    ...
    def create_pages(self):
        ...
        # Experiments page
        self.pages["experiments"] = ExperimentCreator(
            self.content_frame,
            self.db_manager
        )
    ...
    def create_dashboard_page(self):
        ...
        stat_cards = [
            ...
            ("Active Experiments", stats.get("active_experiments", 0), "🧪"),
        ...
        new_experiment_btn = ctk.CTkButton(
            actions_row,
            text="🧪 New Experiment",
        ...
        new_experiment_btn.pack(side="left", padx=10)

        start_session_btn = ctk.CTkButton(
            actions_row,
            text="▶️ Start Session",
            command=lambda: self.show_page("sessions"),
            width=200,
            height=50
        )
