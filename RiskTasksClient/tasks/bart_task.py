...
config, task_config, exp_config = load_task_config('bart')
...
# Get input mode and balloon settings
    ...
    def log_trial_to_db(self, pumps, points, outcome, reaction_time):
        ...
        try:
            ...
            additional_data = {
                ...
                "actions": pumps,  # Number of pumps (actions taken)
                "action_limit": self.max_pumps_this_trial,  # Point where balloon would pop
                "potential_points": pumps * POINTS_PER_PUMP,  # Points that could be earned
                "total_banked": self.total_score,  # Running total of points banked

                # TASK-SPECIFIC FIELDS
                "pumps": pumps,  # Task-specific alias for actions
                "explosion_point": self.max_pumps_this_trial,  # Task-specific name
