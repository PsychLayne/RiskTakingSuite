...
class SettingsPanel(ctk.CTkFrame):
    ...
    def initialize_variables(self):
        ...
        self.bart_keyboard_mode_var = tk.BooleanVar(value=False)  # New variable
    ...
    def load_config_values(self):
        ...
        self.bart_keyboard_mode_var.set(bart_config.get("keyboard_input_mode", False))  # New setting
    ...
    def save_settings(self):
        ...
        self.working_config["tasks"]["bart"] = {
            ...
            "keyboard_input_mode": self.bart_keyboard_mode_var.get()  # New setting
        }
